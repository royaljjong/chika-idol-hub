...
export const CHIKA_GROUPS_VERIFIED: ChikaGroup[] = [
  // ==========================================
  // 1. 도쿄 - 하라주쿠: FRUITS ZIPPER (후르츠 지퍼)
  // ==========================================
  {
    id: 'fruits-zipper',
    ...
    members: [
      ...
      },
      {
        ...
        imageUrl: '/images/members/fz-tsukiashi-amane.svg',
      ...
      },
      {
        ...
        imageUrl: '/images/members/fz-manaka-mana.svg',
      ...
      },
      {
        ...
        imageUrl: '/images/members/fz-hayase-noel.svg',
      ...
      },
      {
        ...
        imageUrl: '/images/members/fz-nakagawa-runa.svg',
  ...
  // ==========================================
  {
    ...
    members: [
      ...
      },
      {
        ...
        imageUrl: '/images/members/ilife-minase-ramu.svg',
      ...
      },
      {
        ...
        imageUrl: '/images/members/ilife-wakaba-noa.svg',
  ...
  // ==========================================
  // 7. 간사이 / 오사카: カラフルスクリーム (Colorful Scream)
  // ==========================================
  {
    id: 'colorful-scream',
    ...
    members: [
      {
        ...
        links: [
          ...
          { type: 'instagram', url: 'https://www.instagram.com/hinami_haruka/', label: { ja: 'Instagram', ko: '인스타그램', en: 'Instagram' }, verified: true, isPrimary: true },
        ],
      },
    ],
  },
...
function seed() {
  ...
  fs.writeFileSync(outPath, JSON.stringify(CHIKA_GROUPS_VERIFIED, null, 2), 'utf-8');
  console.log(`✅ Seeded ${CHIKA_GROUPS_VERIFIED.length} verified real girl groups to data/chika-groups.json`);
}
