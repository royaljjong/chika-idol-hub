  ...
  // 1. KAWAII LAB. (ASOBISYSTEM - Harajuku & Shibuya)
  {
    ...
    members: [
      // FRUITS ZIPPER
      {
        ...
        imageUrl: 'https://fruitszipper.asobisystem.com/assets/img/member/karen.jpg',
      ...
      },
      {
        ...
        imageUrl: 'https://fruitszipper.asobisystem.com/assets/img/member/yui.jpg',
      ...
      },
      {
        ...
        imageUrl: 'https://fruitszipper.asobisystem.com/assets/img/member/suzuka.jpg',
        ...
        links: [
          ...
          { type: 'tiktok', url: 'https://www.tiktok.com/@tarasuzuka24', label: { ja: 'TikTok', ko: '틱톡', en: 'TikTok' }, verified: true, isPrimary: false },
        ],
      },
      {
        ...
        imageUrl: 'https://fruitszipper.asobisystem.com/assets/img/member/amane.jpg',
        birthDate: '1999-10-26',
        birthplace: { ja: '福岡県', ko: '후쿠오카현', en: 'Fukuoka' },
        nickname: { ja: 'あまねき', ko: '아마네키', en: 'Amaneki' },
        links: [
          { type: 'x', url: 'https://x.com/amane_fz1026', label: { ja: 'X (Twitter)', ko: '공식 X (트위터)', en: 'Official X' }, verified: true, isPrimary: true },
          { type: 'instagram', url: 'https://www.instagram.com/amane_tsukiashi_/', label: { ja: 'Instagram', ko: '인스타그램', en: 'Instagram' }, verified: true, isPrimary: true },
        ],
      },
      {
        id: 'fz-manaka-mana',
        ...
        imageUrl: 'https://fruitszipper.asobisystem.com/assets/img/member/mana.jpg',
        birthDate: '1999-04-22',
        birthplace: { ja: '神奈川県', ko: '가나가와현', en: 'Kanagawa' },
        nickname: { ja: 'まなふぃ', ko: '마나피', en: 'Manafi' },
        links: [
          { type: 'x', url: 'https://x.com/mana_fz0422', label: { ja: 'X (Twitter)', ko: '공식 X (트위터)', en: 'Official X' }, verified: true, isPrimary: true },
          { type: 'instagram', url: 'https://www.instagram.com/manamana_fz0422/', label: { ja: 'Instagram', ko: '인스타그램', en: 'Instagram' }, verified: true, isPrimary: true },
        ],
      },
      {
        id: 'fz-hayase-noel',
        ...
        imageUrl: 'https://fruitszipper.asobisystem.com/assets/img/member/noel.jpg',
        birthDate: '2003-12-29',
        birthplace: { ja: 'ドイツ', ko: '독일', en: 'Germany' },
        nickname: { ja: 'ノエル', ko: '노엘', en: 'Noel' },
        links: [
          { type: 'x', url: 'https://x.com/noel_fz1229', label: { ja: 'X (Twitter)', ko: '공식 X (트위터)', en: 'Official X' }, verified: true, isPrimary: true },
          { type: 'instagram', url: 'https://www.instagram.com/noel_hayase/', label: { ja: 'Instagram', ko: '인스타그램', en: 'Instagram' }, verified: true, isPrimary: true },
        ],
      },
      {
        id: 'fz-nakagawa-runa',
        ...
        imageUrl: 'https://fruitszipper.asobisystem.com/assets/img/member/runa.jpg',
        birthDate: '1997-07-03',
        birthplace: { ja: '神奈川県', ko: '가나가와현', en: 'Kanagawa' },
        nickname: { ja: 'るなぴ', ko: '루나피', en: 'Lunapi' },
        links: [
          { type: 'x', url: 'https://x.com/runa_fz0703', label: { ja: 'X (Twitter)', ko: '공식 X (트위터)', en: 'Official X' }, verified: true, isPrimary: true },
    ...
    members: [
      // iLiFE!
      {
        ...
        links: [
          ...
          { type: 'tiktok', url: 'https://www.tiktok.com/@riri_shinzome', label: { ja: 'TikTok', ko: '틱톡', en: 'TikTok' }, verified: true, isPrimary: false },
          { type: 'ticket', url: 'https://ticketdive.com/artist/ilife', label: { ja: 'チケット', ko: '라이브 티켓', en: 'Tickets' }, verified: true, isPrimary: false },
        ],
      },
      {
        id: 'ilife-aisu',
        ...
        links: [
          ...
          { type: 'tiktok', url: 'https://www.tiktok.com/@aisu_ilife', label: { ja: 'TikTok', ko: '틱톡', en: 'TikTok' }, verified: true, isPrimary: false },
        ],
      },
      {
        ...
        links: [
          { type: 'x', url: 'https://x.com/iLiFE_ramu', label: { ja: 'X (Twitter)', ko: '공식 X (트위터)', en: 'Official X' }, verified: true, isPrimary: true },
          { type: 'instagram', url: 'https://www.instagram.com/ramu_minase/', label: { ja: 'Instagram', ko: '인스타그램', en: 'Instagram' }, verified: true, isPrimary: true },
        ],
      },
      {
        id: 'ilife-wakaba-noa',
        ...
        links: [
          { type: 'x', url: 'https://x.com/iLiFE_noa', label: { ja: 'X (Twitter)', ko: '공식 X (트위터)', en: 'Official X' }, verified: true, isPrimary: true },
      ...
      },
      {
        ...
        links: [
          ...
          { type: 'instagram', url: 'https://www.instagram.com/meifujimiya/', label: { ja: 'Instagram', ko: '인스타그램', en: 'Instagram' }, verified: true, isPrimary: true },
        ],
      },
    ],
  },
    ...
    members: [
      {
        ...
        links: [
          ...
          { type: 'instagram', url: 'https://www.instagram.com/nako_colorful/', label: { ja: 'Instagram', ko: '인스타그램', en: 'Instagram' }, verified: true, isPrimary: true },
        ],
      },
    ],
  },
