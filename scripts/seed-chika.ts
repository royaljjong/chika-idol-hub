...
export const CHIKA_GROUPS_DATA: ChikaGroup[] = [
  // 1. KAWAII LAB. (ASOBISYSTEM - Harajuku & Shibuya)
  {
    ...
    accentColor: '#FFE5EC',
    debutYear: 2022,
    imageUrl: '/images/groups/kawaii-lab.svg',
    description: {
  ...
  // 2. HEROINES (imaginate - Shinjuku & Shibuya)
  {
    ...
    accentColor: '#FFD6E5',
    debutYear: 2018,
    imageUrl: '/images/groups/heroines.svg',
    description: {
    ...
    members: [
      ...
      },
      {
        ...
        nickname: { ja: '의아ちゃん', ko: '노아짱', en: 'Noa-chan' },
        links: [
  ...
  // 3. WACK (Shibuya)
  {
    ...
    accentColor: '#111827',
    debutYear: 2014,
    imageUrl: '/images/groups/wack.svg',
    description: {
  ...
  // 4. DEARSTAGE (Akihabara)
  {
    ...
    accentColor: '#E0F7FA',
    debutYear: 2008,
    imageUrl: '/images/groups/dearstage.svg',
    description: {
  ...
  // 5. KANSAI / OSAKA IDOLS (Namba & Shinsaibashi)
  {
    ...
    accentColor: '#E6F9F0',
    debutYear: 2017,
    imageUrl: '/images/groups/kansai-idols.svg',
    description: {
  ...
  // 6. REGIONAL LIVE IDOLS (Sapporo / Nagoya / Fukuoka)
  {
    ...
    accentColor: '#F0F9FF',
    debutYear: 2011,
    imageUrl: '/images/groups/regional-idols.svg',
    description: {
...
function seed() {
  ...
  console.log(`✅ Seeded ${CHIKA_GROUPS_DATA.length} Chika Groups to data/chika-groups.json with local assets`);
}
